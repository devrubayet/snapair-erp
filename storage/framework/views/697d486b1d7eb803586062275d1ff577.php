            ...
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-red-500 rounded-lg bg-red-700 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent">
                ...
                <li>
                    <a href="<?php echo e(route('services')); ?>" 
                        class="block py-2 px-3 rounded md:p-0 <?php echo e(request()->routeIs('services') ? 'text-white font-bold' : 'text-gray-200 hover:text-white'); ?>">Services</a>
                </li>
                <li>
                    <a href="<?php echo e(route('prices')); ?>" 
                        class="block py-2 px-3 rounded md:p-0 <?php echo e(request()->routeIs('prices') ? 'text-white font-bold' : 'text-gray-200 hover:text-white'); ?>">Pricing</a>
                </li>
                <li>
                    <a href="<?php echo e(route('contact')); ?>" 
                        class="block py-2 px-3 rounded md:p-0 <?php echo e(request()->routeIs('contact') ? 'text-white font-bold' : 'text-gray-200 hover:text-white'); ?>">Contact</a>
                </li>
            </ul>
        </div>
    </div>
