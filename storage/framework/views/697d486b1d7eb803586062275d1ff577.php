            ...
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-2 bg-red-700 md:bg-transparent rounded-lg md:rounded-none md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                <li>
                    <a href="<?php echo e(route('home')); ?>"
                        class="block py-2 px-3 rounded md:bg-transparent md:p-0 <?php echo e(request()->routeIs('home') ? 'text-white font-bold bg-red-800 md:bg-transparent' : 'text-gray-200 hover:bg-red-800 md:hover:bg-transparent md:hover:text-white'); ?>"
                        aria-current="page">Home</a>
                </li>
                <li>
                    <a href="<?php echo e(route('about')); ?>"
                        class="block py-2 px-3 rounded md:bg-transparent md:p-0 <?php echo e(request()->routeIs('about') ? 'text-white font-bold bg-red-800 md:bg-transparent' : 'text-gray-200 hover:bg-red-800 md:hover:bg-transparent md:hover:text-white'); ?>">About</a>
                </li>
                <li>
                    <a href="#"
...
</nav><?php /**PATH C:\Users\rubay\Desktop\travel-erp\travel-erp\resources\views/components/frontend/navbar.blade.php ENDPATH**/ ?>