...
<script>
    ...
    const BASE_URL = "<?php echo e(asset('')); ?>";
    const FAVICON_PATH = "<?php echo e(!empty($settings->favicon) ? asset('storage/' . ltrim($settings->favicon, '/')) : ''); ?>";
...
<?php /**PATH C:\Users\rubay\Desktop\travel-erp\travel-erp\resources\views/components/frontend/ticket-and-visa-search.blade.php ENDPATH**/ ?>