                ...
                <div class="space-y-6 lg:col-span-1">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-md border border-gray-200 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm"><?php echo e($settings->phone_primary); ?></p>
                            <p class="text-gray-600 text-sm"><?php echo e($settings->phone_secondary); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-md border border-gray-200 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm"><?php echo e($settings?->email ?? ''); ?></p>
                            <p class="text-gray-600 text-sm"><?php echo e($settings?->support_email ?? ''); ?></p>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="w-full h-80 rounded-2xl overflow-hidden shadow-inner border border-gray-200">
                <iframe 
                    ...
                    src="<?php echo e($settings->google_map_embed); ?>" 
                    allowfullscreen="" 
                    loading="lazy" 
...
<?php echo $__env->make('layouts.frontend.layouts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rubay\Desktop\travel-erp\travel-erp\resources\views/pages/contact.blade.php ENDPATH**/ ?>